...
import locationsImage1 from "../../../assets/images/home/location/location_c1.webp";
import locationsImage2 from "../../../assets/images/home/location/location_c2.webp";
import locationsImage3 from "../../../assets/images/home/location/location_c3.webp";
...
// -------------------------------
const locationsData = [
  { id: 1, name: "Sherwood Park", image: locationsImage1 },
  { id: 2, name: "Spruce Grove", image: locationsImage2 },
  { id: 3, name: "Cameron Heights Edmonton", image: locationsImage3 },
  { id: 4, name: "Whyte Avenue Edmonton", image: locationsImage4 },
  { id: 5, name: "South Common Edmonton", image: locationsImage5 },
  { id: 6, name: "Edmonton Downtown", image: locationsImage6 },
];
...
export default function Locations({
  titleLine1 = contentData.titleLine1,
    ...
    <section className="py-10 w-full bg-white md:py-[45px]">
      <div className="mx-auto max-w-[1280px] px-4 md:px-8">
        <div className="grid grid-cols-1 gap-6 items-center md:gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col justify-between space-y-4 md:space-y-8 lg:h-[536px]">
            {/* Dynamic Title */}
