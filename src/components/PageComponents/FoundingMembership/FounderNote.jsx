  ...
  return (
    <section className="w-full bg-[#f5f5f5] py-14 text-center md:py-[72px]">
      <div className="mx-auto max-w-[1280px] px-4 md:px-6">
        <p className="mb-6 font-['Urbanist'] text-[14px] font-semibold uppercase tracking-[0.2em] text-[#d82028]">
          Founder's Note
        </p>
        <p className="mx-auto mb-7 max-w-[60ch] font-['Urbanist'] text-[16px] text-[#333333]">
        ...
        <p className="mt-2.5 font-['Urbanist'] text-[14px] font-semibold uppercase tracking-[0.18em] text-[#6b6b6b]">
          Founder
        </p>
      </div>
    </section>
