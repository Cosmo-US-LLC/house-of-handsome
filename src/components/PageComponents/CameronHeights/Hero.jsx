...
function Hero() {
  ...
  return (
    // <header id="top" className="relative w-full">
    //   {/* Mobile hero — full-bleed image, text overlaid at the bottom (matches Figma node 2387:6844) */}
    ...
    //       style={{
    //         background:
    //           "linear-gradient(180deg, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0) 40%), linear-gradient(180deg, rgba(0,0,0,0) 43%, rgba(0,0,0,0.95) 95%)",
    //       }}
    //     />

    //     <div className="relative z-10 flex min-h-[100dvh] flex-col justify-end px-4 pb-8 pt-28">
    //       <div className="font-['Urbanist'] text-[12px] font-bold uppercase tracking-[0.08em] text-[#d82028]">
    //         Cameron Heights, Edmonton
    //       </div>

    //       <div className="mt-1 space-y-0.5">
    //         <h1 className="font-['Cairo'] text-[32px] font-bold leading-[1.05] text-white">
    //           Redefine Your Everyday Look.
    //         </h1>
    //         <h2 className="font-['Cairo'] text-[20px] font-medium leading-[1.15] tracking-[-0.75px] text-white">
    //           Skill. Detail. <span className="text-[#d82028]">Confidence.</span>
    //         </h2>
    //       </div>

    //       <p className="mt-2 font-['Urbanist'] text-[14px] font-medium leading-[18px] text-white">
    //         At House of Handsome Cameron Heights, we don't just cut hair, we craft a look that holds up all week.
    //         Every visit pairs sharp technique with genuine care, so you leave the chair sharper than you walked in.
    //       </p>

    //       <div className="mt-4">
    //         <PrimaryCTA onClick={handleBook} className="!w-full !px-4 !py-3 !text-[14px]">
    //           Book An Appointment
    //         </PrimaryCTA>
    //       </div>
    ...
    //           <img src={phorestAward} alt="Phorest Client Experience Award 2026" className="h-8 w-auto shrink-0" />
    //           <div className="flex flex-col leading-tight">
    //             <div className="flex items-baseline">
    //               <span className="font-['Roboto_Slab'] text-[16px] font-bold text-white">4.8</span>
    //               <span className="font-['Roboto_Slab'] text-[12px] font-bold text-white">/5</span>
    //             </div>
    //             <span className="font-['Onest'] text-[10px] font-normal text-white whitespace-nowrap">
    //               Clients Love Us
    //             </span>
    //           </div>
    //         </div>
    ...
    //           <div className="flex flex-col leading-tight">
    //             <div className="flex items-baseline">
    //               <span className="font-['Roboto_Slab'] text-[16px] font-bold text-white">4.9</span>
    //               <span className="font-['Roboto_Slab'] text-[12px] font-bold text-white">/5</span>
    //             </div>
    //             <span className="font-['Onest'] text-[10px] font-normal text-white whitespace-nowrap">
    //               Google Rating
    ...
    //         >
    //           <img src={app_dow1} alt="Get it on Google Play" className="h-10 w-auto" />
    //         </a>
    //         <a
    ...
    //           rel="noopener noreferrer"
    //         >
    //           <img src={app_dow2} alt="Download on the App Store" className="h-10 w-auto" />
    //         </a>
    //       </div>
    //     </div>
    //   </div>

    //   {/* Desktop hero — side-by-side layout with full-bleed background image */}
    //   <div className="mx-auto hidden max-w-[1280px] px-4 md:block md:px-8">
    //     <div className="flex w-full items-start flex-row md:items-center gap-8 md:min-h-[100dvh]">
    //       <div className="relative z-10 w-[60%] space-y-6 pb-4 pt-0 text-left">
    //         <div className="font-['Urbanist'] text-[13px] font-bold uppercase tracking-[0.08em] text-[#d82028]">
    //           Cameron Heights, Edmonton
    //         </div>

    //         <h1 className="font-['Cairo'] font-[700] leading-[114.583%] text-[48px] !text-[#fff] max-w-[531px]">
    //           Redefine Your Everyday Look.
    //         </h1>

    //         <h2 className="font-['Cairo'] !text-[#fff] text-2xl font-semibold lg:text-[38px] lg:leading-[41.36px] lg:tracking-[-0.752px]">
    //           Skill. Detail. <span className="text-[#d82028]">Confidence.</span>
    //         </h2>

    //         <p className="mt-6 max-w-[531px] font-['Urbanist'] text-[18px] font-medium leading-[26px] !text-[#fff]">
    //           At House of Handsome Cameron Heights, we don't just cut hair, we craft a look that holds up all week.
    ...
    //             <PrimaryCTA onClick={handleBook} className="w-auto">
    //               Book An Appointment
    //             </PrimaryCTA>
    //           </div>
    //           <div className="flex items-center gap-6">
    //             <div className="flex items-center gap-3">
    //               <img src={phorestAward} alt="Phorest Client Experience Award 2026" className="h-[47px] w-auto" />
    //               <div className="flex flex-col pb-1 leading-tight">
    //                 <div className="flex items-baseline">
    //                   <span className="font-['Roboto_Slab'] !text-[#fff] text-[30px] font-bold">4.8</span>
    //                   <span className="font-['Roboto_Slab'] text-[16px] font-bold !text-[#fff]">/5</span>
    //                 </div>
    //                 <span className="font-['Onest'] text-[10px] font-normal !text-[#fff]">Clients Love Us</span>
    //               </div>
    //             </div>

    //             <div className="flex items-center gap-4">
    //               <div className="h-[42px] w-[41px]">
    //                 <GoogleIcon />
    //               </div>
    //               <div className="flex flex-col pb-1 leading-tight">
    //                 <div className="flex items-baseline">
    //                   <span className="font-['Roboto_Slab'] !text-[#fff] text-[30px] font-bold">4.9</span>
    //                   <span className="font-['Roboto_Slab'] text-[16px] font-bold !text-[#fff]">/5</span>
    //                 </div>
    //                 <span className="font-['Onest'] text-[10px] font-normal !text-[#fff]">Google Rating</span>
    //               </div>
    //             </div>
    //           </div>
    //         </div>

    //         <div className="mt-8 w-full max-w-[420px] border-t border-white/20" />
    ...
    //               rel="noopener noreferrer"
    //             >
    //               <img src={app_dow1} alt="Get it on Google Play" className="h-12 w-auto" />
    //             </a>
    //             <a
    //               href="https://apps.apple.com/gb/app/house-of-handsome-barbershop/id1588244951"
    //               target="_blank"
    //               rel="noopener noreferrer"
    //             >
    //               <img src={app_dow2} alt="Download on the App Store" className="h-12 w-auto" />
    //             </a>
    //           </div>
    //         </div>
    //       </div>
    ...
    <header className="relative w-full pt-4">
      <div className="mx-auto max-w-[1280px]  px-4 md:px-8 ">
        <div className="flex flex-col gap-6 items-center max-md:justify-center min-h-[720px] w-full md:flex-row md:gap-8">
          <div className="relative z-10 pt-4 pb-4 w-full md:w-[60%] space-y-4 text-left md:space-y-6 md:pt-0">
            <h1
