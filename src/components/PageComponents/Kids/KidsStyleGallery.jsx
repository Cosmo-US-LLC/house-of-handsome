...
const galleryImages = [
  {
    id: 1,
    src: galleryImage1,
    alt: "Kids hairstyle example 1",
    height: "h-[314px]",
  },
  {
    id: 2,
    src: galleryImage2,
    alt: "Kids hairstyle example 2",
    height: "h-[402px]",
  },
  {
    id: 3,
    src: galleryImage3,
    alt: "Kids hairstyle example 3",
    height: "h-[266px]",
  },
  {
    id: 4,
    src: galleryImage4,
    alt: "Kids hairstyle example 4",
    height: "h-[416px]",
  },
  {
    id: 5,
    src: galleryImage5,
    alt: "Kids hairstyle example 5",
    height: "h-[432px]",
  },
  {
    id: 6,
    src: galleryImage6,
    alt: "Kids hairstyle example 6",
    height: "h-[263px]",
  },
  {
    id: 7,
    src: galleryImage7,
    alt: "Kids hairstyle example 7",
    height: "h-[276px]",
  },
  {
    id: 8,
    src: galleryImage8,
    alt: "Kids hairstyle example 8",
    height: "h-[416px]",
  },
  {
    id: 9,
    src: galleryImage9,
    alt: "Kids hairstyle example 9",
    height: "h-[266px]",
  },
  {
    id: 10,
    src: galleryImage10,
    alt: "Kids hairstyle example 10",
    height: "h-[249px]",
  },
  {
    id: 11,
    ...
    <section className="py-16 w-full bg-white">
      ...
      <div className="mx-auto max-w-[1280px] px-4 md:px-8">
        ...
        >
          ...
          h-[40px] md:w-[50px] w-[40px] md:top-[-100px] top-[-46px] translate-x-0 translate-y-0" >
            ...
            <CarouselNext className="right-0 cursor-pointer md:top-[-100px] top-[-46px] md:h-[50px] h-[40px] 
          md:w-[50px] w-[40px] translate-x-0 translate-y-0 cursor-pointer" >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="21" viewBox="0 0 24 21" fill="none">
